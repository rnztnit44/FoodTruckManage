...
public class FoodController {
    ...
    public ResponseEntity<List<FoodTruckPermit>> searchByOwnerName(@PathVariable("name") String ownerName) {
    ...
    public ResponseEntity<List<FoodTruckPermit>> searchByExpiryDate(@PathVariable("expiryDate") Date expiryDate) {
    ...
    public ResponseEntity<List<FoodTruckPermit>> searchByStreetName(@RequestParam String streetName) {
